...
include_once(dirname(__FILE__) . '/eppRequests/feeEppRenewDomainRequest.php');
include_once(dirname(__FILE__) . '/eppResponses/feeEppRenewDomainResponse.php');
...
$this->addCommandResponse('Metaregistrar\EPP\feeEppRenewDomainRequest', 'Metaregistrar\EPP\feeEppRenewDomainResponse');
